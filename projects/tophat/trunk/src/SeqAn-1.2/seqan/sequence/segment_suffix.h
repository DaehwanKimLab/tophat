 ...
 ============================================================================
  $Id: segment_suffix.h 4707 2009-08-24 11:39:52Z weese@PCPOOL.MI.FU-BERLIN.DE $
 ==========================================================================*/
...
template <typename THost_>
inline void 
setHost(Segment<THost_, SuffixSegment> & me, typename _Parameter<THost_>::Type _host)
{
SEQAN_CHECKPOINT
